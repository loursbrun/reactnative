        ...
        <FlatList
          ...
          renderItem={({item}) => (
            <FilmItem
              ...
              isFilmWatched={(this.props.watchedFilms.findIndex(film => film.id === item.id) !== -1) ? true : false}
              displayDetailForFilm={this._displayDetailForFilm}
            />
          )}
          onEndReachedThreshold={0.5}
          onEndReached={() => {
            if ((!this.props.favoriteList || !this.props.watchedList) && this.props.films.length > 0 && this.props.page < this.props.totalPages) {
