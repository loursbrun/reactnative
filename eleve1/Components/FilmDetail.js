...
class FilmDetail extends React.Component {
  ...
  componentDidMount() {
    const watchedFilmIndex = this.props.watchedFilms.findIndex(item => item.id === this.props.navigation.state.params.idFilm)
  ...
  _displayWatchedButton() {
    return (
      ...
      >
        <Text style={styles.watchedButton__Text}>
          { this.state.watched ? 'marqué comme vu' : 'non vu'}
        </Text>
      </TouchableOpacity>
    )
  }
